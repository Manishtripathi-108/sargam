...
When native Qobuz API fails, the provider falls back to external services:

| Priority | Service                                      | Parameter Key |
| -------- | -------------------------------------------- | ------------- |
| 1        | `https://dab.yeet.su/api/stream`             | `trackId`     |
| 2        | `https://dabmusic.xyz/api/stream`            | `trackId`     |
| 3        | `https://qobuz.squid.wtf/api/download-music` | `track_id`    |
| 4        | `https://qobuzapi.vercel.app/api/stream`     | `trackId`     |
| 5        | `https://qobuz.deno.dev/stream`              | `trackId`     |
